...
best_entity_model = os.path.join(output_dir, 'best.entity.mdl')
best_trigger_model = os.path.join(output_dir, 'best.trigger.mdl')
        ...
        if dev_scores[task]['f'] > best_dev[task]:
            ...
            if task == 'role':
                ...
                save_result(dev_result_file,
                            ...
                            dev_tokens)
            if task == 'entity':
                print('Saving best entity model')
                torch.save(state, best_entity_model)
            
            if task == 'trigger':
                print('Saving best trigger model')
                torch.save(state, best_trigger_model)
...
best_score_by_task(log_file, os.path.join(output_dir, 'entity.txt'), 'entity')
best_score_by_task(log_file, os.path.join(output_dir, 'trigger.txt'), 'trigger')
best_score_by_task(log_file, os.path.join(output_dir, 'role.txt'), 'role')
best_score_by_task(log_file, os.path.join(output_dir, 'relation.txt'), 'relation')
